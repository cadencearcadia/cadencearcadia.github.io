...
Since you've added the Web3Forms API key to the Supabase secrets, let's update the Contact component to use it properly. I'll modify the code to use the environment variable that contains your Web3Forms API key.

<lov-code>
Let's update the Contact component to use the API key from the environment variables:

<lov-write file_path="src/components/Contact.tsx">
import { motion } from "framer-motion";
import { Card, CardContent } from "./ui/card";
import { Button } from "./ui/button";
import { Input } from "./ui/input";
